...
def draw_menu():
    ...
    DIS.blit(food_text, [DIS_WIDTH / 2 - food_text.get_width() / 2, DIS_HEIGHT / 2])

    food_start_x = (DIS_WIDTH - (120 * len(FOOD_IMGS))) / 2  # Center the food images
    food_y = DIS_HEIGHT / 2 + 50
    ...
    DIS.blit(info_text, [DIS_WIDTH / 2 - info_text.get_width() / 2, DIS_HEIGHT / 2 + 150])
